...
function CompanyVisits() {
  ...
  const filteredVisits = companyVisits.filter(visit => {
    ...
    const matchRole = filters.role === '' || 
      visit.rolesOffered.some(role => role.toLowerCase().includes(filters.role.toLowerCase()));
    
    const matchBatch = filters.batch === '' || 
      visit.batch.includes(filters.batch);
    ...
    return matchCompany && matchRole && matchBatch && matchMinPackage && matchMaxPackage;
  });
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600 font-semibold">Loading company visits...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              ...
              <p className="text-gray-600 mt-1">Explore companies recruiting at our college</p>
            </div>
            <Link to="/">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          <div className="bg-linear-to-br from-blue-500 to-blue-600 rounded-2xl shadow-lg p-6 text-white">
            <p className="text-blue-100 text-sm font-semibold uppercase">Total Companies</p>
          ...
          <div className="bg-linear-to-br from-green-500 to-emerald-600 rounded-2xl shadow-lg p-6 text-white">
            <p className="text-green-100 text-sm font-semibold uppercase">Total Opportunities</p>
          ...
          <div className="bg-linear-to-br from-purple-500 to-pink-600 rounded-2xl shadow-lg p-6 text-white">
            <p className="text-purple-100 text-sm font-semibold uppercase">Active Batches</p>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-100">
          <div className="flex items-center justify-between mb-4">
            <h3 className="text-xl font-bold text-gray-800">🔍 Filter Companies</h3>
            <button 
          ...
          <div className="mt-4 text-sm text-gray-600">
            Showing <strong>{filteredVisits.length}</strong> of <strong>{companyVisits.length}</strong> companies
          </div>
        </div>
        ...
        {filteredVisits.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-md p-12 text-center border border-gray-100">
            ...
            <p className="text-gray-600 text-lg font-semibold">No companies found</p>
                  ...
                  <div className="flex-1">
                    <div className="flex items-start justify-between mb-4">
                      ...
                      <div className="text-right">
                        <p className="text-sm text-gray-500 mb-1">Package Range</p>
                    ...
                    <div className="space-y-4">
                      <div>
                        <p className="text-sm font-semibold text-gray-700 mb-2">🎯 Roles Offered:</p>
                      ...
                      <div>
                        ...
                        <p className="text-gray-700 bg-linear-to-r from-blue-50 to-purple-50 p-4 rounded-lg leading-relaxed">
                          {visit.jobDescription}
                        </p>
                      </div>

                      <div className="text-sm text-gray-500">
                        Added on: {new Date(visit.createdAt).toLocaleDateString('en-IN', {
                          day: 'numeric',
                          month: 'long',
                          year: 'numeric'
                        })}
